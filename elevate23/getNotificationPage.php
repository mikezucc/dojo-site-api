<?php
	...
	$querystring = "select * from noti2 where (forwhom='$username' and seen='no') order by made desc;";
	$result = mysqli_query($link, $querystring);
	$newResults = array();
	while($queryresponse = mysqli_fetch_assoc($result))
	{
	...
	$querystring = "select * from noti2 where (forwhom='$username') order by made desc limit 40;";
	$result = mysqli_query($link, $querystring);
	$notiResults = array();
	while($queryresponse = mysqli_fetch_assoc($result))
	{
